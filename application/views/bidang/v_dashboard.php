<div class="col-12 mt-5">
	<div class="pl-3 py-4">
		<div class="card card-light enable-shadow">
			<div class="card-header bg-success text-white">
				<h4 class="card-title mb-0">
					...
					<div class="float-none float-md-right mt-2 mt-md-0">
						<a href="#" class="btn btn-sm btn-block btn-light" role="button" data-toggle="modal" data-target="#BidMod"><i class="fa fa-plus mr-2"></i> Tambah <?= $Title ?></a>
					</div>
			...
			<div class="card-body">
				<div class="table-responsive">
					<table class="table table-sm table-striped table-bordered" id="dtBid">
						<thead>
							<tr>
								<th>No</th>
								<th>Nama</th>
		...
		<div class="modal fade bd-example-modal-lg" id="BidMod" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title"><i class="fa fa-building mr-3"></i> Tambah Data <?= $Title ?></h5>
					</div>
					<?= form_open("#",array('id' => 'FrmBid')) ?>
...
<?php $this->load->view('bidang/js/js_page_dashboard') ?>